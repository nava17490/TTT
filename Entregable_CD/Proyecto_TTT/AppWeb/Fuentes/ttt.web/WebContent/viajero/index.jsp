...
<div id="pagina">
    ...
    <div id="contenedor">
    	<div id="listalineas">
        	<div id="todas" onclick="todas()" onmouseover="this.style.cursor='pointer';">
            	<h1>Todas las paradas</h1>
            	<script type="text/javascript">
				function todas() {
					//limpiar detalle
        ...
        <div id="detalle">
                                ...
                                <h5 style="width:1000px;"><a href="./ayuda.jsp">Ayuda para el viajero</a> - <a href='../control/index.jsp'>Pasar a aplicación de Control</a> - <a href="../viajero/mapa.jsp">Mapa web</a> - <a href="../viajero/contacto.jsp">Contacto</a></h5>
